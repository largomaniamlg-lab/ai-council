...
export const es: Dictionary = {
  ...
  acta: {
    ...
    roundHeading: "Ronda",
    roundOfLabel: "de",
    verdictMaintained: "El Consejo mantiene su posicion",
    verdictRevised: "El Consejo revisa su posicion",
    verdictMixed: "Posturas divididas en el Consejo",
    stanceMaintain: "Mantiene su postura",
    stanceRevise: "Revisa su postura",
    trendUp: "Confianza en aumento",
    trendDown: "Confianza en descenso",
    trendStable: "Confianza estable",
    challengeSectionTitle: "Continuar la deliberacion",
    challengePlaceholder:
      "Ej: No estoy de acuerdo con el Director de Riesgos. ¿Que pasaria si duplicamos el presupuesto?",
    challengeButton: "🏛 Desafiar al Consejo",
    challenging: "El Consejo esta reconsiderando...",
    askModeratorButton: "Pregunta rapida al Moderador",
    askingModerator: "El Moderador esta respondiendo...",
    maxRoundsReached:
  ...
  history: {
    ...
    backToConsole: "Volver al Consejo",
    searchPlaceholder: "Buscar por problema o titulo...",
    filterProjectLabel: "Proyecto",
    filterModeLabel: "Modo",
    filterLocaleLabel: "Idioma",
    allProjects: "Todos los proyectos",
    allModes: "Todos los modos",
    allLocales: "Todos los idiomas",
    noSessions: "No hay sesiones guardadas todavia.",
    noSupabaseHint:
      "Sin Supabase configurado, el historial se guarda solo en este navegador (localStorage).",
    statusInProgress: "En curso",
    statusCompleted: "Completada",
    statusDecisionSaved: "Decision guardada",
    openButton: "Abrir",
    deleteButton: "Eliminar",
    deleteConfirm: "¿Eliminar esta sesion? Esta accion no se puede deshacer.",
